...
public interface PayStation {
     ...
     *
     * @param insertedSoFar is an integer value representing the coin in cent. That
     * is, a quarter is insertedSoFar=25, etc.
     * @throws IllegalCoinException in case insertedSoFar is not a valid coin value
     */
    public void addPayment(int insertedSoFar) throws IllegalCoinException;
