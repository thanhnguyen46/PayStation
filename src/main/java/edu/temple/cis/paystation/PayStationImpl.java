...
public class PayStationImpl implements PayStation {
    ...
    public PayStationImpl(RateStrategy rateS){
        insertedSoFar = timeBought = totalMoney = 0;
        this.coinMap = new HashMap<>();
        this.rateStrategy = rateS;
    }
    ...
    public void addPayment(int coinValue)
        ...
        switch (coinValue) {
            ...
            case 10:
            case 25:
            case 100: //added 1 dollar coin for easy testing
                break;
            default:
    ...
    @Override
    public void changeStrategy(RateStrategy updatedStrategy) {
        this.rateStrategy = updatedStrategy;
    }

    // Display coins that are inserted so far
    public int coinInPayStation() {
        int tempCoin = 0;
        tempCoin += insertedSoFar;
        return tempCoin;
    }
    // TESTING PURPOSE ONLY
    public String currentRate() {
        return rateStrategy.toString();
    }
}
